...
namespace Dw.Repositories.Helpers
{
    public static class EntityHelper
    {
        public static void UpdateFromDto(IEntityVersion original, object modificationDto, DwDbContext context, bool stateModified = true)
        {
            if (stateModified)
            {
        ...
        public static void Update(IEntityVersion original, IEntityVersion modification, DwDbContext context)
        {
            context.Entry(original).State = EntityState.Modified;
